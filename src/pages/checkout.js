...
const Checkout = ({ context }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!street || !city || !postal_code || !state) {
      setErrorMessage("Preencha o formulário");
      return;
    }
  ...
  if (orderCompleted) {
    return (
      <div>
        <h3>Obrigado! Sua compra foi processada.</h3>
      </div>
    );
  }
    ...
    <div className="flex flex-col items-center pb-10">
      ...
      >
        <div className="pt-10 pb-8">
          <h1 className="text-5xl font-light">Pagamento</h1>
          <Link to="/cart">
            ...
            <div className="flex flex-1 flex-col md:flex-row">
              ...
              <div className="md:pt-20">
                ...
                <div className="ml-4 pl-2 flex flex-1 justify-end pr-4">
                  <p className="text-sm pr-10">Frete</p>
                  <p className="tracking-tighter w-38 flex justify-end">
                    Gratis
                  </p>
                </div>
